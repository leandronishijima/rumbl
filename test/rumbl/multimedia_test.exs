defmodule Rmbl.MultimediaTest do
  ...
  describe "videos" do
    ...
    test "create_video/2 with invalid data returns a error changeset" do
      owner = user_fixtures()
    ...
    test "update_video/2 with invalid data returns error dataset" do
      owner = user_fixtures()
      %Video{id: id} = video = video_fixtures(owner)
